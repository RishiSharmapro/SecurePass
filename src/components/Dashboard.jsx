...
const Dashboard = () => {
  ...
  const getPasswords = async () => {
    let response = await fetch(`${import.meta.env.VITE_BACKEND_URL}`);
  ...
  const handleSave = async () => {
    ...
    // );
    axios.post(`${import.meta.env.VITE_BACKEND_URL}`, { ...encryptedPasswordObj, id: currId });
  ...
  const handleEdit = async (id) => {
    ...
    axios.delete(`${import.meta.env.VITE_BACKEND_URL}`, pass);
